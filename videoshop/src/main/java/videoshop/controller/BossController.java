...
class BossController {
    ...
    @RequestMapping("/sufu")
    public String sufoo(ModelMap modelMap) {
        for (disc : this.inventory.findAll()){
           system.out.println(disc.toStr());
        }
        //test: gebe alle zurueck
        modelMap.addAttribute("sufu", inventory.findAll());
        return "orders";
}
