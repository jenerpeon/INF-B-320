...
public class CreditComparatorTest{
	...
	model2 = new ConcreteUserAccount("test@mail.com", "Username2","Firstname", "Lastname", "Adress","ZipCode", "City", "Password", Role.of("ROLE_EMPLOYEE"),u);
	...
	assertTrue("compare",comparator.compare(model1, model2)==6);
	}
