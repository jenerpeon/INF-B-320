...
public class CreditmanagerTest {
	...
	this.acc = new ConcreteUserAccount("test@mail.com", "Username2","Firstname", "Lastname", "Adress","ZipCode", "City", "Password", Role.of("ROLE_EMPLOYEE"),u);
...
//
//	orderManager.payOrder(order);// only set orderManager.payOrder(o), do not use orderManager.completeOrder(0), to complete Order look at the next line!
//	
//	this.o.setStatus(OrderStatus.COMPLETED); // to complete Order do not use orderManager.completeOrder
...
//	orderManager.save(order);
	...
	public void testupdateCreditpointsByUser(){
		...
		//assertTrue("UpdatePoints", acc.getCredits()==14);
