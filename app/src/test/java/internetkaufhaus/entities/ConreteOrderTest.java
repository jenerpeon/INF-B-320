...
public class ConreteOrderTest {
	...
	public void init() {
		...
		ConcreteProduct prod1 = new ConcreteProduct(
				"CIMAROSA Sauvignon Blanc Marlborough Estate Selection, Weißwein 2014", Money.of(5.49, EURO), Money.of(5.00, EURO), "Wein",
		...
		ConcreteProduct prod2 = new ConcreteProduct("Allini Pinot Chardonnay, Schaumwein", Money.of(2.49, EURO), Money.of(0, EURO), "Wein",
