...
public class Initialize implements DataInitializer {
	...
	private void initializeCatalog(Catalog<ConcreteProduct> productCatalog, Search productSearch) {
		...
		prods.add(new ConcreteProduct("CIMAROSA Sauvignon Blanc Marlborough Estate Selection, Weißwein 2014",
				Money.of(5.49, EURO), (float) 4.39, "Wein",
		...
		prods.add(new ConcreteProduct("Allini Pinot Chardonnay, Schaumwein", Money.of(2.49, EURO), (float) 1.99, "Wein",
		...
		prods.add(new ConcreteProduct("Agostón Cariñena D.O. Joven, Roséwein 2014", Money.of(3.49, EURO), (float) 2.79,
				"Wein",
		...
		prods.add(new ConcreteProduct("Banyuls AOP Baucéant, Rotwein 2008", Money.of(3.99, EURO), (float) 3.19, "Wein",
		...
		prods.add(new ConcreteProduct("Alliance Vin Mousseux, Schaumwein ", Money.of(3.99, EURO), (float) 3.19, "Wein",
		...
		prods.add(new ConcreteProduct("5 Oros Rioja D.O.Ca Joven, Rotwein 2014", Money.of(3.99, EURO), (float) 3.19,
				"Wein",
		...
		prods.add(new ConcreteProduct("Canforrales Jumilla DOC, Weißwein 2014", Money.of(4.99, EURO), (float) 3.99,
				"Wein",
		...
		prods.add(new ConcreteProduct("CAÑO Toro do Vino de Autor DO, Rotwein 2011", Money.of(5.49, EURO), (float) 4.39,
				"Wein",
		...
		prods.add(
				new ConcreteProduct("Chandesais Chablis AOP, Weißwein 2011", Money.of(7.99, EURO), (float) 6.39, "Wein",
		...
		prods.add(new ConcreteProduct("NIGRA Riesling trocken, Deutscher Jahrgangs-/Winzersekt 2013",
				Money.of(8.49, EURO), (float) 6.79, "Wein",
		...
		prods.add(new ConcreteProduct("Carpe Diem Málaga D.O., Rotwein", Money.of(8.99, EURO), (float) 7.19, "Wein",
		...
		prods.add(new ConcreteProduct("Château D'Arcole Saint-Emilion Grand Cru AOP, Rotwein 2011",
				Money.of(15.99, EURO), (float) 12.79, "Wein",
		...
		prods.add(new ConcreteProduct("VIAJERO Casato dei Medici Riccardi Bolgheri DOC, Rotwein 2012",
				Money.of(11.99, EURO), (float) 9.59, "Wein",
		...
		prods.add(new ConcreteProduct("Riesling Mosel QbA, Weißwein 2014", Money.of(3.29, EURO), (float) 2.63, "Wein",
		...
		prods.add(new ConcreteProduct("Ron Botucal Reserva Exclusiva (ehem. Diplomatico) Premium Rum - 0,7L 40% vol ",
				Money.of(29.49, EURO), (float) 23.59, "Spirituosen",
		...
		prods.add(new ConcreteProduct("Plantation Barbados Extra Old 20th Anniversary Rum, Premium - 0,7L 40% vol ",
				Money.of(38.18, EURO), (float) 30.54, "Spirituosen",
		...
		prods.add(new ConcreteProduct("Canadian Club Whisky - 0,7L 40% vol", Money.of(10.59, EURO), (float) 8.47,
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Russian Standard Vodka - 1 Liter 40% vol", Money.of(13.25, EURO), (float) 10.6,
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Gordons Dry Gin - 1 Liter 37,5% vol", Money.of(14.04, EURO), (float) 11.23,
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("J & B Whisky Scotch Whisky - 0,7L 40% vol", Money.of(12.41, EURO), (float) 9.93,
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Strega Likör Kräuterlikör - 0,7L 40% vol", Money.of(15.49, EURO), (float) 12.39,
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Belvedere Premium Vodka - 0,7L 40% vol", Money.of(29.78, EURO), (float) 23.82,
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Kahlua Kaffeelikör - 0,7L 20% vol ", Money.of(12.52, EURO), (float) 10.02,
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Aigner No.1, Eau de Toilette, 50 ml", Money.of(19.99, EURO), (float) 15.99,
				"Parfums",
		...
		prods.add(new ConcreteProduct("Gucci Rush 2, Eau de Toilette", Money.of(75.99, EURO), (float) 60.79, "Parfums",
		...
		prods.add(
				new ConcreteProduct("Cacharel Lou Lou, Eau de Parfum", Money.of(56.99, EURO), (float) 45.59, "Parfums",
		...
		prods.add(new ConcreteProduct("Chopard Casmir, Eau de Parfum", Money.of(39.99, EURO), (float) 31.99, "Parfums",
		...
		prods.add(new ConcreteProduct("Calvin Klein Obsession, Eau de Parfum", Money.of(19.99, EURO), (float) 15.99,
				"Parfums",
		...
		prods.add(new ConcreteProduct("DKNY Woman, Eau de Toilette", Money.of(51.99, EURO), (float) 41.59, "Parfums",
		...
		prods.add(new ConcreteProduct("Cacharel Anaïs Anaïs, Eau de Toilette", Money.of(82.99, EURO), (float) 66.39,
				"Parfums",
		...
		prods.add(new ConcreteProduct("Joop! Femme, Eau de Toilette", Money.of(19.99, EURO), (float) 15.99, "Parfums",
		...
		prods.add(new ConcreteProduct("Calvin Klein ck be, Eau de Toilette", Money.of(39.99, EURO), (float) 31.99,
				"Parfums",
		...
		prods.add(new ConcreteProduct("Joop! Go!, Eau de Toilette", Money.of(49.99, EURO), (float) 39.99, "Parfums",
		...
		prods.add(new ConcreteProduct("Davidoff Cool Water Man, Eau de Toilette", Money.of(19.99, EURO), (float) 15.99,
				"Parfums",
		...
		prods.add(new ConcreteProduct("Calvin Klein Escape, Eau de Parfum", Money.of(24.99, EURO), (float) 19.99,
				"Parfums",
				"Lassen Sie sich in faszinierende \"Duft-Erlebnis-Welten\" entführen und erleben Sie bei uns erfolgreiche Marken und Aktionen. Spontan wie das Leben - Überraschungsmomente genießen!",
		...
		prods.add(new ConcreteProduct("Paloma Picasso Minotaure, Pour Homme, Eau de Toilette, 75 ml",
				Money.of(39.99, EURO), (float) 31.99, "Parfums",
		...
		prods.add(
				new ConcreteProduct("Diesel Loverdose, Eau de Parfum", Money.of(43.99, EURO), (float) 35.19, "Parfums",
		...
		prods.add(new ConcreteProduct("Amor Kette mit Anhänger \"471794\"", Money.of(99.95, EURO), (float) 79.96,
				"Schmuck",
		...
		prods.add(new ConcreteProduct("Bering Damen Kombiring", Money.of(129.9, EURO), (float) 103.92, "Schmuck",
		...
		prods.add(new ConcreteProduct("Leonardo Kette mit Anhänger \"Matrix 015567\"", Money.of(44.95, EURO),
				(float) 35.96, "Schmuck", "Zarte Kette aus dem Hause Leonardo.", "https://eng.wikipedia.org/wiki/Fuzz",
				"SProdukt_015567_1_K.jpg"));
		prods.add(new ConcreteProduct("S.Oliver Ring \"540285\" mit Swarovski® Kristallen, Edelstahl",
				Money.of(69.99, EURO), (float) 55.99, "Schmuck",
		...
		prods.add(new ConcreteProduct("Bering Ring, Edelstahl, braun", Money.of(29, EURO), (float) 23.2, "Schmuck",
		...
		prods.add(
				new ConcreteProduct("Bering Armband, Edelstahl, braun", Money.of(99.9, EURO), (float) 79.92, "Schmuck",
		...
		prods.add(new ConcreteProduct("Michael Kors Armreif", Money.of(149, EURO), (float) 119.2, "Schmuck",
		...
		prods.add(
				new ConcreteProduct("Yvette Ries Ohrstecker, 925er Silber", Money.of(99, EURO), (float) 79.2, "Schmuck",
		...
		prods.add(new ConcreteProduct("S.Oliver Kette mit Anhänger und Diamond Dust Effekt \"561068\"",
				Money.of(99.99, EURO), (float) 79.99, "Schmuck",
		...
		prods.add(new ConcreteProduct("Fossil Armband", Money.of(45, EURO), (float) 36, "Schmuck",
		...
		prods.add(new ConcreteProduct("Celesta Damenring, 925er Silber, rhodiniert, rosévergoldet",
				Money.of(29.95, EURO), (float) 23.96, "Schmuck",
