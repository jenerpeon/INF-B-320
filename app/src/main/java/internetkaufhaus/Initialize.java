...
public class Initialize implements DataInitializer {
	...
	private void initializeCatalog(Catalog<ConcreteProduct> productCatalog, Search productSearch) {
		...
		prods.add(new ConcreteProduct("Allini Pinot Chardonnay, Schaumwein", Money.of(2.49, EURO), Money.of(1.99, EURO), "Wein",
		...
		prods.add(new ConcreteProduct("Agostón Cariñena D.O. Joven, Roséwein 2014", Money.of(3.49, EURO), Money.of(2.79, EURO),
				"Wein",
		...
		prods.add(new ConcreteProduct("Banyuls AOP Baucéant, Rotwein 2008", Money.of(3.99, EURO), Money.of(3.19, EURO), "Wein",
		...
		prods.add(new ConcreteProduct("Alliance Vin Mousseux, Schaumwein ", Money.of(3.99, EURO), Money.of(3.19, EURO), "Wein",
		...
		prods.add(new ConcreteProduct("5 Oros Rioja D.O.Ca Joven, Rotwein 2014", Money.of(3.99, EURO), Money.of(3.19, EURO),
				"Wein",
		...
		prods.add(new ConcreteProduct("Canforrales Jumilla DOC, Weißwein 2014", Money.of(4.99, EURO), Money.of(3.99, EURO),
				"Wein",
		...
		prods.add(new ConcreteProduct("CAÑO Toro do Vino de Autor DO, Rotwein 2011", Money.of(5.49, EURO), Money.of(4.39, EURO),
				"Wein",
		...
		prods.add(
				new ConcreteProduct("Chandesais Chablis AOP, Weißwein 2011", Money.of(7.99, EURO), Money.of(6.39, EURO), "Wein",
		...
		prods.add(new ConcreteProduct("Carpe Diem Málaga D.O., Rotwein", Money.of(8.99, EURO), Money.of(7.19, EURO), "Wein",
		...
		prods.add(new ConcreteProduct("Riesling Mosel QbA, Weißwein 2014", Money.of(3.29, EURO), Money.of(2.63, EURO), "Wein",
		...
		prods.add(new ConcreteProduct("Canadian Club Whisky - 0,7L 40% vol", Money.of(10.59, EURO), Money.of(8.47, EURO),
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Russian Standard Vodka - 1 Liter 40% vol", Money.of(13.25, EURO), Money.of(10.6, EURO),
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Gordons Dry Gin - 1 Liter 37,5% vol", Money.of(14.04, EURO), Money.of(11.23, EURO),
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("J & B Whisky Scotch Whisky - 0,7L 40% vol", Money.of(12.41, EURO), Money.of(9.93, EURO),
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Strega Likör Kräuterlikör - 0,7L 40% vol", Money.of(15.49, EURO), Money.of(12.39, EURO),
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Belvedere Premium Vodka - 0,7L 40% vol", Money.of(29.78, EURO), Money.of(23.82, EURO),
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Kahlua Kaffeelikör - 0,7L 20% vol ", Money.of(12.52, EURO), Money.of(10.02, EURO),
				"Spirituosen",
		...
		prods.add(new ConcreteProduct("Aigner No.1, Eau de Toilette, 50 ml", Money.of(19.99, EURO), Money.of(15.99, EURO),
				"Parfums",
		...
		prods.add(new ConcreteProduct("Gucci Rush 2, Eau de Toilette", Money.of(75.99, EURO), Money.of(60.79, EURO), "Parfums",
		...
		prods.add(
				new ConcreteProduct("Cacharel Lou Lou, Eau de Parfum", Money.of(56.99, EURO), Money.of(45.59, EURO), "Parfums",
		...
		prods.add(new ConcreteProduct("Chopard Casmir, Eau de Parfum", Money.of(39.99, EURO), Money.of(31.99, EURO), "Parfums",
		...
		prods.add(new ConcreteProduct("Calvin Klein Obsession, Eau de Parfum", Money.of(19.99, EURO), Money.of(15.99, EURO),
				"Parfums",
		...
		prods.add(new ConcreteProduct("DKNY Woman, Eau de Toilette", Money.of(51.99, EURO), Money.of(41.59, EURO), "Parfums",
		...
		prods.add(new ConcreteProduct("Cacharel Anaïs Anaïs, Eau de Toilette", Money.of(82.99, EURO), Money.of(66.39, EURO),
				"Parfums",
		...
		prods.add(new ConcreteProduct("Joop! Femme, Eau de Toilette", Money.of(19.99, EURO), Money.of(15.99, EURO), "Parfums",
		...
		prods.add(new ConcreteProduct("Calvin Klein ck be, Eau de Toilette", Money.of(39.99, EURO), Money.of(31.99, EURO),
				"Parfums",
		...
		prods.add(new ConcreteProduct("Joop! Go!, Eau de Toilette", Money.of(49.99, EURO), Money.of(39.99, EURO), "Parfums",
		...
		prods.add(new ConcreteProduct("Davidoff Cool Water Man, Eau de Toilette", Money.of(19.99, EURO), Money.of(15.99, EURO),
				"Parfums",
		...
		prods.add(new ConcreteProduct("Calvin Klein Escape, Eau de Parfum", Money.of(24.99, EURO), Money.of(19.99, EURO),
				"Parfums",
				"Lassen Sie sich in faszinierende \"Duft-Erlebnis-Welten\" entführen und erleben Sie bei uns erfolgreiche Marken und Aktionen. Spontan wie das Leben - Überraschungsmomente genießen!",
		...
		prods.add(
				new ConcreteProduct("Diesel Loverdose, Eau de Parfum", Money.of(43.99, EURO), Money.of(35.19, EURO), "Parfums",
		...
		prods.add(new ConcreteProduct("Amor Kette mit Anhänger \"471794\"", Money.of(99.95, EURO), Money.of(79.96, EURO),
				"Schmuck",
		...
		prods.add(new ConcreteProduct("Bering Damen Kombiring", Money.of(129.9, EURO), Money.of(103.92, EURO), "Schmuck",
		...
		prods.add(new ConcreteProduct("Leonardo Kette mit Anhänger \"Matrix 015567\"", Money.of(44.95, EURO),
				Money.of(35.96, EURO), "Schmuck", "Zarte Kette aus dem Hause Leonardo.", "https://eng.wikipedia.org/wiki/Fuzz",
		...
		prods.add(new ConcreteProduct("Bering Ring, Edelstahl, braun", Money.of(29, EURO), Money.of(23.2, EURO), "Schmuck",
		...
		prods.add(
				new ConcreteProduct("Bering Armband, Edelstahl, braun", Money.of(99.9, EURO), Money.of(79.92, EURO), "Schmuck",
		...
		prods.add(
				new ConcreteProduct("Yvette Ries Ohrstecker, 925er Silber", Money.of(99, EURO), Money.of(79.2, EURO), "Schmuck",
