...
public class SortHelper {
	...
	private class Record {
		...
		public String toString() {
			return "Record{" + "index=" + index + ", columns=" + columns + '}';
		}
	}
	 ...
	 * 
	 * @param index
	 *            - The index in the list being sorted
	 * @param objects
	 *            - Only those columns that needs to be sorted and in the order it should be sorted
	 */
	...
	public Comparator getBooleanComparator(int index) {
		...
		Comparator<Record> retval = (object1, object2) -> Boolean.compare((Boolean) object1.getColumns().get(index), (Boolean) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getByteComparator(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> Byte.compare((Byte) object1.getColumns().get(index), (Byte) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getDoubleComparator(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> Double.compare((Double) object1.getColumns().get(index), (Double) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getIntegerComparator(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> Integer.compare((Integer) object1.getColumns().get(index), (Integer) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getLongCompartor(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> Long.compare((Long) object1.getColumns().get(index), (Long) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getShortComparator(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> Short.compare((Short) object1.getColumns().get(index), (Short) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getFloatCompartor(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> Float.compare((Float) object1.getColumns().get(index), (Float) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getStringComparator(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> ((String) object1.getColumns().get(index)).compareTo((String) object2.getColumns().get(index));
		return retval;
	}
	...
	public Comparator getDateComparator(int index) {
		...
		// Get the comparator using Java 8 lambda expression
		Comparator<Record> retval = (object1, object2) -> ((Date) object1.getColumns().get(index)).compareTo((Date) object2.getColumns().get(index));
		return retval;
	}

	/**
	 * Depending on the number of columns it will create a list of keys with some fake name. Also the method determines the class type of the data
	 */
